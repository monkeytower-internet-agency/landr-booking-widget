  ...
  return (
    <DayPicker
      ...
      className={cn(
        ...
        "group/calendar bg-background p-0 sm:p-3 [--cell-size:--spacing(11)] sm:[--cell-size:--spacing(9)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
